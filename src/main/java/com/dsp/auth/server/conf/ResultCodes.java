...
public enum ResultCodes {
    ...
    ACCOUNT_ENDPOINT_LIMITED(40103, "您已经使用其它终端登录,请先退出其它终端"),
    ACCOUNT_EXPIRED(40104, "该账户已经过期"),
    ACCOUNT_LOCKED(40105, "该账户已经被锁定"),
    BAD_CREDENTIALS(40106, "用户名或密码错误"),
    CREDENTIALS_EXPIRED(40107, "该账户密码凭证已过期"),
    INVALID_CLIENT(40108, "客户端身份验证失败"),
    INVALID_TOKEN(40109, "提供的访问令牌已过期、吊销、格式错误或无效"),
    INVALID_GRANT(40110, "提供的授权授予或刷新令牌无效、已过期或已撤销"),
    UNAUTHORIZED_CLIENT(40111, "客户端无权使用此方法请求授权码或访问令牌"),
    USERNAME_NOT_FOUND(40112, "用户名或密码错误"),
    SESSION_EXPIRED(40113, "Session 已过期，请刷新页面后再使用"),
     ...
     */
    INVALID_REDIRECT_URI(41201, "OAuth2 URI 重定向的值无效"),
    INVALID_REQUEST(41202, "无效的请求，参数使用错误或无效."),
